...
int main(){
	...
	while (true)
	{
		...
		float X =((1920-x*1920/640)-510)*4.9/2.4; 			//640 - const from kinect, probably the size of with depth sensor
		float Y = (y * 1200 / 280 - 430)*4/1.4;				//280 - const from kinect, probably the size of heith depth sensor
